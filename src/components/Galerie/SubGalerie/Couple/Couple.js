...
import { Carousel, Image, Col, Row, Modal, Button, Container  } from 'react-bootstrap';
import { motion, AnimateSharedLayout, AnimatePresence } from 'framer-motion';

//Image Background
import Galerie4 from '../../../../images/galerie/couple10.jpg'
...
export default function Couple() {
    ...
    return (
        <Wrapper>
            ...
            <h4 className='galerie-title'>Couple</h4>

            <Modal show={show} fullscreen={fullscreen} onHide={() => setShow(false)}>
                <Modal.Header closeButton style={{backgroundColor: '#7AA5D2'}}>
                    <Modal.Title style={{textAlign: 'center', width: '100%'}}>Couple</Modal.Title>
                </Modal.Header>
                <Modal.Body>
